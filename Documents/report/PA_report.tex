...
\textbf{Have to:} You are now in your browser and have open the source file "inphinity/show\_phamily.ipynb". The class "sea\_inphinity()" have every methods that we use in this part. cf. file if you want to see it all.
