...
\todo phages Vs bacteria

\todo genome

\todo sequence alignment

\chapter{Scientific aspects}

\section{Biology}
\section{Bio-informatic}

\chapter{Work Presentation}
...
\section{First result with Phamerator}
\section{Database}
...
\section{Week 24-01 February}
\textbf{first contact}

\todo PV --> copy notes manuscrite HERE

\textbf{Lectures}

Readings about biology and bio-informatic

\textbf{Virtual machine}

After some research about various tools found during my readings, I set-up a first virtual machine with Linux and some necessary packages.

\textbf{Specifications}

\section{Week 02-08 Mars}
\textbf{Reunion}
